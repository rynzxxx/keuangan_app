...
class LaporanPerubahanModal extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('dashboard_keuangan/laporan_perubahan_modal/index', $data);
    }
    ...
    public function new()
    {
        ...
        return view('dashboard_keuangan/laporan_perubahan_modal/new', $data);
    }
    ...
    public function detail($id)
    {
        ...
        return view('dashboard_keuangan/laporan_perubahan_modal/detail', $data);
    }
}
